                            ...
                            @foreach($ongoings as $ongoing)
                                <div class="panel panel-default">
                                    <div class="panel-body left-border-purple">
                                        ...
                                        <br>
                                        <ul class="list-unstyled">
                                            <li class="pull-right"><a href="{{ route('proyek_tugas.pindah_kanan', $ongoing->id) }}" data-toggle="tooltip" title="Pindah ke Request Selesai"><span class="glyphicon glyphicon-arrow-right" style="padding-left: 5px"></span> </a></li>
                                            <li class="pull-left"><a href="{{ route('proyek_tugas.pindah_kiri', $ongoing->id) }}" data-toggle="tooltip" title="Kembalikan ke To Do"><span class="glyphicon glyphicon-arrow-left"></span> </a></li>
                                        </ul>
                                    </div>
